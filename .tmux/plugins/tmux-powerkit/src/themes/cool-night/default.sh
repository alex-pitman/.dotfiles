...
# =============================================================================
# Theme: Cool Night
# Description: A modified version of Tokyo Night
# =============================================================================
...
declare -gA THEME_COLORS=(
    ...
    # STATUS BAR
    # =========================================================================
    [statusbar-bg]="#112638"             # Status bar background
    [statusbar-fg]="#c0caf5"             # Status bar text color

    # =========================================================================
    # SESSION (status-left)
    # =========================================================================
    [session-bg]="#65d1ff"               # Session normal background
    [session-fg]="#292e42"               # Session text color
[session-prefix-bg]="#44ffb1"        # Session prefix mode background
    ...
    # =========================================================================
    [window-active-base]="#a277ff"       # Active window base color
    ...
    # Variants auto-generated: -lighter (index bg), -darker (text contrast)
    # =========================================================================
    [window-inactive-base]="#214969"     # Inactive window base color
    ...
    # =========================================================================
    [ok-base]="#214969"                  # OK state base color
